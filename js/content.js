...
function initialize() {
    chrome.runtime.sendMessage(
        ...
        function (response) {
            if (response.ready) {
                Utils.log('Inicializando extensão...')
...
const cardHTML = `<div
    ...
    <div id="card-default-view">
        <div class="mdc-card-header">
            ...
            <div>
                <h2 class="CkXZgc card-title" id="class-label">Ver Classe</h2>
            </div>
            <button
        ...
        <div
            ...
            class="mdc-linear-progress"
            id="progress-bar"
            aria-label="Exportação em progresso"
            aria-valuemin="0"
            aria-valuemax="1"
            aria-valuenow="0"
        >
                ...
                <div class="label CkXZgc">Student Names</div>
                    ...
                    >
                        ...
                        <textarea
                            ...
                            rows="6"
                            cols="100"
                            aria-label="Insira o nome do aluno"
        ...
        >
            ...
            <div id="dialog-edit-view" hidden>
                <div class="mdc-dialog__content" id="dialog-content">
                    ...
                    <div class="label CkXZgc">Nome(s) do(s) Aluno(s)</div>
                    <label
                        class="mdc-text-field mdc-text-field--outlined mdc-text-field--textarea mdc-text-field--no-label"
                    >
                        <div
