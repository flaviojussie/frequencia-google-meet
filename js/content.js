chrome.storage.local.get('updates-dismissed', function (response) {
    ...
    function instantiate() {
        chrome.runtime.sendMessage(
            ...
            function () {
                Utils.log('Extensão iniciada com sucesso.')
            }
        )
    }
    ...
    const updatesHTML = `<div class="updates ${
        ...
        <div class="notification">
            <div style="flex: 1">
                <p style="margin-bottom: 0">
                    ...
                    <b>Novidades da versão ${
                        chrome.runtime.getManifest().version
                    }</b>
                </p>
                <ul>
                    <li>Configuração de limite atual
                        <ul>
                            <li>Defina quanto tempo um aluno deve estar no Meet antes de ser considerado presente</li>
                            <li>Padrão: 0 minutes</li>
                        </ul>
                    </li>
                    <li>Exportar agora cria notificações do sistema operacional para rastrear o progresso
                    <li>Seções de ajuda abaixo de certas configurações para esclarecer sua finalidade
                    <li>Várias mudanças visuais e correções de bugs</li>
                </ul>
            </div>
        </div>
        ...
        <div class="updates-actions">
            <button class="view-changelog mdc-button" style="float: left">
                ...
                <span class="mdc-button__label">Ver alteração</span>
            </button>
            <button class="dismiss-updates mdc-button" style="float: right">
                <span class="mdc-button__ripple"></span>
                <span class="mdc-button__label">Dispensar</span>
            </button>
        </div>
    </div>`
    ...
    const cardHTML = `<div
        ...
        "
        aria-label="Gerenciar frequência"
        >
        <div hidden id="card-class-view">
            <div class="mdc-card-header">
                <div>
                    <h2 class="CkXZgc card-title">Selecionar Sala</h2>
                </div>
                ${
                    // <button
            ...
            <div class="class-content">
                ...
                <div id="no-classes" class="notification" style="display: none">
                    ...
                    <p>
                        Você não tem aulas! Adicione uma sala clicando no
                        botão abaixo.
                    </p>
                </div>
                <button class="mdc-button" id="addeth-class">
                    ...
                    <i class="material-icons mdc-button__icon" aria-hidden="true"
                        >add</i
                    >
                    <span class="mdc-button__label">Adicionar sala</span>
                </button>
            </div>
            <div
                role="progressbar"
            ...
            <div style="text-align: center">
                <button class="mdc-button" id="edit-roster">
                    ...
                    <i
                        ...
                        >edit</i
                    >
                    <span class="mdc-button__label">Editar Sala</span>
                </button>
            </div>
            <div class="mdc-list-divider" role="separator"></div>
            <div>
                <div 
                    ...
                    jscontroller="VXdfxd" 
                    jsaction="mouseenter:tfO1Yc; mouseleave:JywGue;"
                    data-tooltip="Exibir detalhes de status" 
                    data-tooltip-vertical-offset="-12" 
                    data-tooltip-horizontal-offset="0"
                    aria-label="Mostrar detalhes do estado"
                    aria-pressed="false"
                    aria-expanded="false"
                    role="button" 
                    tabindex="0"
                >
                    <span 
                        id="status-green" 
                        style="width: 100%"
                        aria-label="Presentes: 0/0"
                    ></span>
                    <span 
                        id="status-yellow" 
                        style="width: 0%"
                        aria-label="Anteriormente Presentes: 0/0"
                    ></span>
                    <span 
                        id="status-red" 
                        style="width: 0%"
                        aria-label="Ausentes: 0/0"
                    ></span>
                </div>
                <div id="status-details" class="collapsed">
                    <div id="status-presence">
                        <div>
                            ...
                            <div class="status-details-text">presentes</div>
                        </div>
                        <div>
                            ...
                            <div class="status-details-text">anteriormente presentes</div>
                        </div>
                        <div>
                            ...
                            <div class="status-details-text">ausentes</div>
                        </div>
                    </div>
                    <div 
                        id="status-unlisted" 
                        ...
                        data-tooltip-vertical-offset="-12"
                        data-tooltip-horizontal-offset="0"
                        aria-label="Saltar para Não listado"
                        aria-disabled="true"
                        role="button" 
                        tabindex="0"
                    >
                    ...
                    <button id="hide-status-details" class="mdc-button">
                        <span class="mdc-button__ripple"></span>
                        <span class="mdc-button__label">Ocultar</span>
                    </button>   
                </div>
            </div>
            <div class="mdc-list-divider" role="separator"></div>
        ...
        <div hidden id="card-edit-view">
            <div class="mdc-card-header">
                ...
                <div>
                    <h2 class="CkXZgc card-title">Adicionar/Editar Sala</h2>
                </div>
                <button
                    class="mdc-icon-button medium-button material-icons right"
                    style="right: 48px"
                    ...
                    <div class="label CkXZgc">Nomes dos Alunos</div>
                        ...
                        >
                            ...
                            <textarea
                                ...
                                rows="6"
                                cols="100"
                                aria-label="Insira os Nomes dos Alunos"
            ...
            >
                ...
                <div id="dialog-default-view">
                    <div class="mdc-dialog__content class-content" id="dialog-content">
                        ...
                        <div id="no-classes" class="notification" style="display:none;">
                            ...
                            <p>Você não tem salas! Adicione uma sala clicando no botão abaixo.</p>
                        </div>
                        <button 
                            class="mdc-button" 
                            id="addeth-class" 
                    ...
                    <div class="mdc-dialog__actions">
                        ...
                        >
                            <div class="mdc-button__ripple"></div>
                            <span class="mdc-button__label">Depois</span>
                        </button>
                        <button
                            type="button"
                ...
                <div id="dialog-edit-view" hidden>
                    <div class="mdc-dialog__content" id="dialog-content">
                        ...
                        <div class="label CkXZgc">Nome dos Alunos</div>
                        <label
                            class="mdc-text-field mdc-text-field--outlined mdc-text-field--textarea mdc-text-field--no-label"
                        >
                            <div
                            ...
                            <textarea
                                ...
                                rows="6"
                                cols="100"
                                aria-label="Insira o Nome dos Alunos"
                                aria-controls="student-helper-id"
                                aria-describedby="student-helper-id"
                            ></textarea>
                            <span class="mdc-notched-outline">
    ...
    const buttonHTML = `<div 
        ...
        jsname="VyLmyb"
        aria-haspopup="true"
        aria-label="Vizualizar Frequência"
        aria-disabled="false"
        tabindex="0"
        data-tooltip="Vizualizar Frequência"
        aria-expanded="true"
        data-tab-id="0"
        data-tooltip-vertical-offset="-12"
        data-tooltip-horizontal-offset="0"
